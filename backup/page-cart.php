		...
		?>
			...
			<form class="contactForm" action="page-cart.php" method="post">
				...
				<div class="contactForm-info">
					...
					<span class="contactForm-info-error" id="customer_name_error">Неверное имя</span>
					...
					<span class="contactForm-info-error" id="customer_email_error">Неверный формат e-mail</span>
					...
					<span class="contactForm-info-error" id="customer_phone_error">Неверный номер телефона</span>
